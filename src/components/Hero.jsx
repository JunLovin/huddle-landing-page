            ...
            <div className="hero-container flex flex-col justify-center gap-8">
                <div className="hero-text flex flex-col gap-3">
                    <div className="hero-text-header text-center">
                        <h1 className="font-poppins font-extrabold text-6xl leading-normal max-2xl:text-5xl max-2xl:mt-70 max-sm:text-3xl max-sm:px-12 max-sm:-mt-12">Build The Community Your Fans Will Love</h1>
                    </div>
                    <div className="hero-text-paragraph text-center">
                        <p className="font-open-sans w-[50ch] leading-normal mx-auto max-sm:px-12">Huddle re-imagines the way we build communities. You have a voice, but so does your audience. Create connections with your users as you engage in genuine discussion.</p>
                    </div>
                </div>
                ...
                <div className="Mockup mt-20 mx-auto max-lg:px-8 max-sm:px-16">
