...
function Header() {
    ...
    return (
        <>
        <header className="flex justify-between px-20 h-22 items-end mb-12 max-sm:px-8 max-[480px]:px-4">
            <div className="header-left">
                <img src={Logo} alt="Huddle" className="cursor-pointer max-[480px]:w-[200px] max-[480px]:h-[36px] max-[400px]:w-[160px] max-[400px]:h-[30px]" onClick={handleHome}/>
            </div>
