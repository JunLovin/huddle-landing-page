...
function Footer() {
    ...
    const checkEmail = () => {
        if (!email.toLowerCase().match(/^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|.(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/)) {
            ...
            setError(false)
            inputRef.current.style.borderColor = 'currentColor'
        }
    }
            ...
            <div className="footer-left flex flex-col gap-6 relative">
                ...
                <div className="contact flex flex-col gap-5">
                    ...
                    <div className="email flex gap-4 items-center">
                        ...
                        <a href="mailto:example@huddle.com" target="_blank" className="hover:underline underline-offset-2">example@huddle.com</a>
                    </div>
                </div>
                <div className="social-media absolute left-0 -bottom-24 flex gap-4">
                    <svg  xmlns="http://www.w3.org/2000/svg"  width="28"  height="28"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  strokeWidth="2"  strokeLinecap="round"  strokeLinejoin="round" className="cursor-pointer hover:stroke-[#1877F2] transition-all duration-200"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M7 10v4h3v7h4v-7h3l1 -4h-4v-2a1 1 0 0 1 1 -1h3v-4h-3a5 5 0 0 0 -5 5v2h-3" /></svg>                
                    <svg  xmlns="http://www.w3.org/2000/svg"  width="28"  height="28"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  strokeWidth="2"  strokeLinecap="round"  strokeLinejoin="round" className="cursor-pointer hover:stroke-pink-700 transition-all duration-200"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M4 8a4 4 0 0 1 4 -4h8a4 4 0 0 1 4 4v8a4 4 0 0 1 -4 4h-8a4 4 0 0 1 -4 -4z" /><path d="M9 12a3 3 0 1 0 6 0a3 3 0 0 0 -6 0" /><path d="M16.5 7.5v.01" /></svg>
                    <svg  xmlns="http://www.w3.org/2000/svg"  width="28"  height="28"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  strokeWidth="2"  strokeLinecap="round"  strokeLinejoin="round" className="cursor-pointer hover:fill-[#FFF] hover:stroke-[#FFF] transition-all duration-200"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M4 4l11.733 16h4.267l-11.733 -16z" /><path d="M4 20l6.768 -6.768m2.46 -2.46l6.772 -6.772" /></svg>            
                </div>
            </div>
            <div className="footer-right flex flex-col gap-8">
                <div className="footer-right-top flex flex-col gap-3">
                    <h4 className="font-poppins font-extrabold text-2xl">NEWSLETTER</h4>
                    <p className="max-w-[50ch]">To receive tips on how to grow your community, sign up to our weekly newsletter. We'll never send you spam or pass on your email address.</p>
                </div>
                <div className="footer-right-bottom flex justify-center gap-4 relative">
                    <input type="text" id="email" name="email" placeholder="example@domain.com" className="bg-white px-4 py-2 rounded-xl outline-none text-black w-xs border-2 border-curent" onChange={handleEmail} ref={inputRef} onKeyDown={handleEnter} />
                    {error && (
                        <>
                        <label htmlFor="email" className="text-red-400 absolute -bottom-8 left-2 font-semibold">Check your email please</label>
                        </>
                    )}
                    <button className="bg-pink-400 text-white w-max px-10 py-3 rounded-xl shadow-2xl cursor-pointer font-bold active:bg-pink-500 transition-all duration-200" onClick={checkEmail}>Subscribe</button>
                </div>
            </div>
        </footer>
        </>
