...
function Footer() {
    ...
    return (
        ...
        <footer className="w-full min-h-[60dvh] flex justify-around items-center bg-[#00252e] text-white relative mt-[-5px] pb-8 max-lg:py-16 px-4 max-lg:flex-col-reverse max-lg:gap-20">
            <div className="footer-left flex flex-col gap-6 relative max-lg:mb-16 max-w-xl">
            ...
            <div className="footer-right flex flex-col gap-8">
                ...
                <div className="footer-right-bottom flex justify-center gap-4 relative max-lg:flex-col max-lg:items-end max-lg:gap-0">
